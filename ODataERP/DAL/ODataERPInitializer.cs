...
namespace ODataERP.DAL
{
    public class ODataERPInitializer : DropCreateDatabaseIfModelChanges<ODataERPContext>
    {
        protected override void Seed(ODataERPContext context)
        {
            ...
            {
                new Product { ID = 1, Name = "Saft", Price = 0.99M },
                new Product { ID = 2, Name = "Bier", Price = 2.99M },
                new Product { ID = 3, Name = "Brot", Price = 0.99M },
                new Product { ID = 4, Name = "Fleisch", Price = 3.99M },
                new Product { ID = 5, Name = "Müsli", Price = 1.99M },
                new Product { ID = 6, Name = "Milch", Price = 0.99M },
                new Product { ID = 7, Name = "Schokolade", Price = 0.99M },
                new Product { ID = 8, Name = "Chips", Price = 0.99M },
                new Product { ID = 9, Name = "Pizza", Price = 0.99M },
                new Product { ID = 10, Name = "Wurst", Price = 0.99M }
            };
